...
tags: swiftui, wwdc, wwdc26, WWDC26 Notes
...
![Active appearance](../../Resources/posts/whats-new-in-swiftui/images/7222D2BD-ECD8-4C9A-94C1-6F691D1779AE.png)
...
![CommandMenu text-only default](../../Resources/posts/whats-new-in-swiftui/images/782AACCF-D117-4933-8751-72A0D482A712.png)

Xcode SwiftUI previews now have resizability handles.

![Xcode preview resizability handles](../../Resources/posts/whats-new-in-swiftui/images/29E46826-D475-474F-87D8-1CA4107DABDC.png)

These handles hint at foldable iPhone support and surface best practices around adaptive layouts.

![Resizability guidance](../../Resources/posts/whats-new-in-swiftui/images/6C898649-95DB-449D-AD25-D2B1B3444378.png)

New tab role to make a trailing tab bar item stand out — similar to how the search tab already behaves in iOS 26.

![New tab role](../../Resources/posts/whats-new-in-swiftui/images/19D6EFE0-BA80-4C97-B42E-F808E5B987E3.png)
...
![visibilityPriority modifier](../../Resources/posts/whats-new-in-swiftui/images/547CB4C7-6780-4727-8749-7431DF994225.png)

A new `ToolbarOverflowMenu` container lets you opt specific items *into* the overflow menu explicitly.

![ToolbarOverflowMenu](../../Resources/posts/whats-new-in-swiftui/images/0D3AA5C9-FB6D-435E-B684-F159EAAB7015.png)
...
![topBarPinnedTrailing placement](../../Resources/posts/whats-new-in-swiftui/images/893491CD-07AE-40A0-95D2-72937C401E2A.png)

New `toolbarMinimizeBehavior` modifier to hide the toolbar on scroll.

![toolbarMinimizeBehavior](../../Resources/posts/whats-new-in-swiftui/images/BE5E04F5-C54A-4AA8-A9AF-C2F9DE15A50C.png)

## Document Based Apps

Multiple new APIs for document-based apps.

![Document app new features overview](../../Resources/posts/whats-new-in-swiftui/images/42398661-F30E-4072-8383-86779037E539.png)

New creation context API to start a document from different starting points.

![Creation context API](../../Resources/posts/whats-new-in-swiftui/images/F6941CBC-5E94-4EA3-8C65-E46EC60F9E04.png)
...
![WritableDocument and ReadableDocument protocols](../../Resources/posts/whats-new-in-swiftui/images/D181E250-912F-4F79-9210-43802552FDBC.png)

## Presentation and Interactions

New `.reorderable` modifier and `.reorderContainer` modifier make it easy to support drag and drop in views beyond just lists.

![reorderable and reorderContainer modifiers](../../Resources/posts/whats-new-in-swiftui/images/6A68DFA9-9706-46EA-8F16-C941D305D5AE.png)
...
![Swipe actions on any container](../../Resources/posts/whats-new-in-swiftui/images/770882D2-5CD8-4FF1-A2E1-20EA4CF8D6E5.png)
...
![Item-binding confirmation dialog API](../../Resources/posts/whats-new-in-swiftui/images/D98813F2-6221-4B0C-A3C2-538D7E58F873.png)

![Item-binding alert API](../../Resources/posts/whats-new-in-swiftui/images/C5474889-E7C4-4DCF-B2D6-0AF1C131C3D1.png)
...
![AsyncImage with URLCache](../../Resources/posts/whats-new-in-swiftui/images/416C5BE6-9CAA-4483-9301-B55381C83E0A.png)

You can also swap the underlying `URLSession` to control cache size.

![AsyncImage custom URLSession](../../Resources/posts/whats-new-in-swiftui/images/D2D17DB3-DFF7-4208-A94C-470061448C1D.png)
...
![Storing Observable in @State — before](../../Resources/posts/whats-new-in-swiftui/images/40EE96ED-7569-41A0-BD62-9EDD425193EF.png)

![Storing Observable in @State — after](../../Resources/posts/whats-new-in-swiftui/images/8CD09830-93E3-4EF3-B3FB-645AF05D86B0.png)
...
![Breaking change example](../../Resources/posts/whats-new-in-swiftui/images/3045F025-96B0-4E18-89CE-6181DF3D6A38.png)
...
![Unified @ContentBuilder](../../Resources/posts/whats-new-in-swiftui/images/107F27F1-97C4-48DA-B474-6EE5D80FFE4F.png)

New agent skills for agentic coding workflows are also available via `xcrun`.

![Agentic coding support](../../Resources/posts/whats-new-in-swiftui/images/86AFF107-CE25-475B-A783-AB2627791A21.png)

![xcrun agent skills export](../../Resources/posts/whats-new-in-swiftui/images/F409E32E-1509-4DE6-A6E4-508A55EE2C45.png)
